...
class TableViewWindow:#TODO:update window when card got deleted,make all into one window
    ...
    def createTableViewWindow(self, cardList, dontShowCardsWithQuantityZero):
